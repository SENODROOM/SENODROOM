...
┌─────────────────────────────────────────────────────────────────────┐
│  🚧  PROJECT ALPHA                                                   │
│      Description of what you're building — replace this!            │
│      Stack: React · Node.js · PostgreSQL                            │
│      Status: ██████████░░░░░░░░░░ 55% — In Development             │
├─────────────────────────────────────────────────────────────────────┤
│  🛠️  PROJECT BETA                                                    │
│      Another cool thing you're working on — replace this!           │
│      Stack: Next.js · Python · Docker                               │
│      Status: ████████████████░░░░ 80% — Almost There               │
├─────────────────────────────────────────────────────────────────────┤
│  💡  SIDE QUEST                                                      │
│      An experiment, a tool, or an open source contribution          │
│      Stack: TypeScript · AWS · MongoDB                              │
│      Status: ████░░░░░░░░░░░░░░░░ 20% — Just Started               │
└─────────────────────────────────────────────────────────────────────┘
```
